PublicHolidays.registerFactory 'at',
  holidays: (year) ->
    ...
    [
      ...
      new PublicHolidays.Day context.set({ month: 4, day: 1 }), "labour_day"
      ...
      new PublicHolidays.Day context.set({ month: 11, day: 25 }), "christmas"
      new PublicHolidays.Day context.set({ month: 11, day: 26 }), "st_stephen"
    ]
